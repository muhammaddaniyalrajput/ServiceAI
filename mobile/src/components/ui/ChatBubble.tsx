/**
 * ChatBubble — single message bubble for the KaamEasy AI design system.
...
export interface ChatBubbleProps {
  text: string;
  /** Whether this message was authored by the current viewer. */
  isMe: boolean;
  /** Single character (e.g. "A") used inside the avatar circle for incoming messages. */
  avatarLabel?: string;

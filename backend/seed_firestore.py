...
This reads from data/mock_providers.py and writes each provider to
...
def main():
    ...
    print(f"🔄 Seeding {len(MOCK_PROVIDERS)} providers to Firestore...")
    ...
    for provider in MOCK_PROVIDERS:
        ...
        print(f"   ✅ {doc_id}: {provider.name} ({provider.service})")

    print()
    print(f"🎉 Done! {len(MOCK_PROVIDERS)} providers seeded to 'providers' collection.")

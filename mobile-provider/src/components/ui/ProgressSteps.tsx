/**
 * ProgressSteps — horizontal step indicator for the KaamEasy Provider design system.
 * Used for booking lifecycle: pending → accepted → on_the_way → arrived → in_progress → completed.
 */
            ...
            >
              {step.glyph ? (
                <Text
                  style={[
                    styles.glyph,
                    { color: isCompleted ? '#000' : AppColors.textMuted },
                  ]}
                >
                  {step.glyph}
                </Text>
